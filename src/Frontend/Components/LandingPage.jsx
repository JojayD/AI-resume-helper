		...
		<div className='flex flex-col h-screen w-full'>
			<div className='h-1/3 w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'>
				<div className='flex items-center justify-between w-full flex-grow px-10 py-5'>
					<h1 className='text-5xl font-bold text-white'>GeekResume</h1>
				...
				>
					...
					<div className='absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse transform'>
						{images.map((_, index) => (
							<button
								key={index}
								type='button'
